...
conv_codebook_index, fc_codebook_index, codebook_value \
    = helper.load_codebook(net, quantization_result_path, quantization_conv_bits, quantization_fc_bits)
# Init net using codebook
helper.codebook_to_init(net, conv_layer_num, nz_num, conv_diff, fc_diff,
                        conv_codebook_index, fc_codebook_index, codebook_value, quantization_conv_bits, quantization_fc_bits)
